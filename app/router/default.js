module.exports = (app) => {
  ...
  router.get(
    "/default/getDetailBanner",
    controller.default.home.getDetailBanner
  );
  router.get(
    "/default/getSearchBanner",
    controller.default.home.getSearchBanner
  );
  ...
  router.get(
    "/default/getUserArticleList",
    controller.default.home.getUserArticleList
  );
  router.get(
    "/default/getUserArticleTotal",
    controller.default.home.getUserArticleTotal
  );

  router.post("/default/login", controller.default.user.login);
  router.get(
    "/default/getWeiboUserInfo",
    controller.default.user.getWeiboUserInfo
  );
  ...
  router.post(
    ...
    jwt,
    controller.default.user.updateUserInfo
  );
  router.post(
    "/default/updatePassword",
    jwt,
    controller.default.user.updatePassword
  );
  router.post(
    "/default/updateMobile",
    jwt,
    controller.default.user.updateMobile
  );
  ...
  router.post(
    "/default/addEditContact",
    jwt,
    controller.default.user.addEditContact
  );
  router.post("/default/delContact", jwt, controller.default.user.delContact);
  router.post(
    "/default/addEditReward",
    jwt,
    controller.default.user.addEditReward
  );
  ...
  router.get(
    "/default/getArticleInfo",
    controller.default.article.getArticleInfo
  );
  router.get(
    "/default/getArticleComment",
    controller.default.article.getArticleComment
  );
  router.post(
    "/default/setArticleComment",
    jwt,
    controller.default.article.setArticleComment
  );
  router.post(
    "/default/commentClickLike",
    jwt,
    controller.default.article.commentClickLike
  );
  router.get(
    "/default/articleClickLike",
    jwt,
    controller.default.article.articleClickLike
  );
  router.get(
    "/default/getLikeStatus",
    jwt,
    controller.default.article.getLikeStatus
  );
  router.get("/default/getVerify", controller.default.article.getVerify);

  // 七牛云token
  router.get(
    "/default/getQiniuToken",
    jwt,
    controller.public.qiniu.getQiniuToken
  );
  // 和风天气
