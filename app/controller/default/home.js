...
class HomeController extends Controller {
  ...
  async getBannerList() {
    let sql1 =
      "SELECT  * FROM banner WHERE `status` = '1' AND `type` = '1' ORDER BY 'createTime' DESC LIMIT 5";
    let sql2 =
      "SELECT  * FROM banner WHERE `status` = '1' AND `type` = '2' ORDER BY 'createTime' DESC LIMIT 2";
    let sql3 =
      "SELECT  * FROM banner WHERE `status` = '1' AND `type` = '3' ORDER BY 'createTime' DESC LIMIT 2";
    let sql4 =
      "SELECT  * FROM banner WHERE `status` = '1' AND `type` = '4' ORDER BY 'createTime' DESC LIMIT 1";
  ...
  async getListBanner() {
    let sql =
      "SELECT  * FROM banner WHERE `status` = '1' AND `type` = '5' ORDER BY 'createTime' DESC LIMIT 1";
    const result = await this.app.mysql.query(sql);
    this.ctx.body = {
      code: 200,
      data: result,
  ...
  async getDetailBanner() {
    let sql =
      "SELECT  * FROM banner WHERE `status` = '1' AND `type` = '6' ORDER BY 'createTime' DESC LIMIT 1";
    const result = await this.app.mysql.query(sql);
    this.ctx.body = {
      code: 200,
      data: result,
  ...
  async getSearchBanner() {
    let sql =
      "SELECT  * FROM banner WHERE `status` = '1' AND `type` = '7' ORDER BY 'createTime' DESC LIMIT 1";
    const result = await this.app.mysql.query(sql);
    this.ctx.body = {
      code: 200,
      data: result,
  ...
  async getUserList() {
    ...
    for (let i = 0; i < result.length; i++) {
      ...
      if (result[i].id) {
        result[i].contact = await this.app.mysql.query(
          queryUSerContactSql(result[i].id)
        );
      }
    }
